...
-- -----------------------------------------------------
-- Table `hw2`.`Prerequisite`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hw2`.`Prerequisite` (
  `CourseID` VARCHAR(20) NOT NULL,
  ...
  CONSTRAINT `fk_Prerequisite_1`
    ...
    REFERENCES `hw2`.`Course` (`CourseID` , `FullName`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Table `hw2`.`Sections`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hw2`.`Sections` (
  `CourseID` VARCHAR(20) NOT NULL,
  `CourseName` VARCHAR(50) NOT NULL,
  ...
  CONSTRAINT `fk_Sections_2`
    ...
    REFERENCES `hw2`.`Faculty` (`FacultyID` , `FirstName` , `LastName`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `hw2`.`Has_enrolled_in`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hw2`.`Has_enrolled_in` (
  `StudentID` VARCHAR(50) NOT NULL,
  ...
  CONSTRAINT `fk_has_enrolled_in_1`
    ...
    REFERENCES `hw2`.`Student` (`StudentID` , `FirstName` , `LastName`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_has_enrolled_in_2`
    FOREIGN KEY (`CourseID` , `CourseName` , `SectionNumber`)
    REFERENCES `hw2`.`Sections` (`CourseID` , `CourseName` , `SectionNumber`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `hw2`.`Has_completed`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hw2`.`Has_completed` (
  `StudentID` VARCHAR(50) NOT NULL,
  `StudentFName` VARCHAR(45) NOT NULL,
  `StudentLName` VARCHAR(45) NOT NULL,
  `CourseID` VARCHAR(20) NOT NULL,
...
-- Table `hw2`.`Serves_in`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hw2`.`Serves_in` (
  ...
  CONSTRAINT `fk_Serves_in_2`
    ...
    REFERENCES `hw2`.`Department` (`ID` , `Name`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `hw2`.`Offered_by`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hw2`.`Offered_by` (
  `DeptID` INT(8) NOT NULL,
...
-- Table `hw2`.`Headed_by`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hw2`.`Headed_by` (
  `DeptID` INT(8) NOT NULL,
  `DeptName` VARCHAR(20) NOT NULL,
  `FacultyID` VARCHAR(50) NOT NULL,
  `FacultyFName` VARCHAR(45) NOT NULL,
