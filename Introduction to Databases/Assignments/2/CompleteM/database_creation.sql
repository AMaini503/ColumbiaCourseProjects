...
CREATE TABLE IF NOT EXISTS `hw2m`.`Prerequisite` (
  ...
  INDEX `fk_Prerequisite_idx_1` (`CourseID` ASC, `CourseName` ASC),
  PRIMARY KEY (`CourseID`, `CourseName`, `PrereqCourseID`, `PrereqCourseName`),
  INDEX `fk_Prerequisite_idx_2` (`PrereqCourseID` ASC, `PrereqCourseName` ASC),
